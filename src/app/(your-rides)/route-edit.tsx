      ...
      <View className="bg-white rounded-t-3xl px-[28px] pt-[43px] -mt-8 z-10">
        ...
        {routesData.map(({ id, title, description }) => {
          ...
          return (
            <TouchableOpacity
              ...
              activeOpacity={0.8}
              className={`border px-[20px] py-[20px] rounded-2xl mb-4 flex-row justify-between items-center ${
                isSelected
            ...
            >
              <View className="flex-1">
                ...
                <Text
                  fontSize={10}
                  className="text-[10px] font-[Kanit-Regular] text-[#999999]"
                >
                  {description}
                </Text>
              </View>
        ...
        <View className="py-5">
          <TouchableOpacity
            ...
            onPress={() => router.push("/(your-rides)/your-publication")}
            activeOpacity={0.8}
          >
            <Text
              fontSize={20}
