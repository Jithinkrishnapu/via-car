...
export default function YourPublicationScreen() {
  ...
  const menuItems: MenuItems[] = [
    ...
    { label: t("yourPublication.route"), route: "/(your-rides)/route-edit" },
    {
      label: t("yourPublication.price"),
      sub: t("yourPublication.priceSub"),
      route: "/(your-rides)/show-pricing",
    },
    {
      label: t("yourPublication.seatOptions"),
      route: "/(your-rides)/passenger-options",
    },
  ];
      ...
      <View className="max-w-[716px] w-full self-center px-6 pt-16 lg:pt-20 pb-24 flex-col gap-4">
        ...
        <View className="flex-row items-center gap-4 mb-6">
          <TouchableOpacity
            ...
            activeOpacity={0.8}
          >
            {swap(<ChevronLeft size={20} />, <ChevronRight size={20} />)}
          </TouchableOpacity>
          <Text
            fontSize={25}
          ...
          {menuItems.map((item, idx) => (
            ...
            >
              ...
              {swap(
                ...
                <ChevronLeft size={25} strokeWidth={1} color="#666666" />
              )}
            </TouchableOpacity>
          ))}
