  ...
  return (
    <View className="max-w-[894px] w-full self-center px-6 pt-16 lg:pt-20 pb-12 lg:pb-24 flex flex-col gap-4 flex-1 bg-white">
      ...
      <TextInput
        ...
        multiline
        className="flex-1 text-[10px] font-[Kanit-Light] bg-[#F5F5F5] rounded-2xl p-6 max-h-[200px]"
        style={{ textAlignVertical: "top", minHeight: 228 }}
      />

      {/* Publish Button */}
      <View className="absolute bottom-8 left-0 right-0 px-6">
        <TouchableOpacity
          onPress={() => router.push("/publish-ride")}
          activeOpacity={0.8}
